package br.com.sysmap.bootcamp.vinil_ecommerce_api.config;
...
/**
 * The type Spring doc api config.
 */
@Configuration
  ...
  public OpenAPI openAPI() {
    return new OpenAPI()
        .info(new Info()
            ...
            .contact(new Contact().name("Samuel Deotti").email("samuel_deotti@hotmail.com")))
